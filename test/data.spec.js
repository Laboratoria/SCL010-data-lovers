...
describe('orderData', () => {
  it('Debería ser una función', () => {
    assert.equal(typeof window.orderData, 'function');
  });
  it('Debería retornar data ordenada', () => {
    assert.deepEqual(window.orderData(sampleSpice, "az"),
      [{
        "name": "Amish Cyborg",
        "status": "Dead",
        "species": "Alien",
  ...
  it('Debería retornar data ordenada de z-a', () => {
    assert.deepEqual(window.orderData(sampleSpice, "za"),
      [{
        "name": "Summer Smith",
        "status": "Alive",
        "species": "Human",
